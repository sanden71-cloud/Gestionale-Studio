...
if st.session_state.show_utility:
    from utility_pages import render_utility
    _app_dir = os.path.dirname(os.path.abspath(__file__))
    render_utility(st, {
        "auth": _auth,
        "is_admin": _is_admin,
        ...
        "df_pr": df_pr,
        "df_prot": df_prot,
        "read_changelog_for_version": read_changelog_for_version,
        "read_update_info": read_update_info,
        "parse_version": parse_version,
        "read_update_ack": _read_update_ack,
        "write_update_ack": _write_update_ack,
        "data_mod": data_mod,
    })
